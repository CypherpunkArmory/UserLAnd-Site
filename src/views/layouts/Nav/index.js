		...
		return (
			<nav className='navbar navbar-expand-lg pt-3 position-absolute w-100'>
				<div className='container'>
					<Link className='navbar-brand' to='/' aria-label='home' title='Go to Home Page'><Logo /></Link>
					<ul className='flex-row navbar-nav ml-auto'>
						...
						<li className='nav-item'><a className='nav-link' aria-label='twitter' href='https://github.com/CypherpunkArmory/UserLAnd'><FontAwesomeIcon icon={['fab', 'github']} size='lg' /></a></li>
					</ul>
				</div>
			</nav>
		);
