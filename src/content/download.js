  ...
  setupSteps: [
    ...
    },
    {
      ...
      body: [
        ...
        { component: (props) => <Link className="link link_underline" to="/signup" {...props}/>, content: "Sign up to create an account." },
      ]
    },
    {
      ...
      body: [
        ...
        { component: (props) => <Link className="link link_underline" to="/docs" {...props}/>, content: "Check out what else you can do." },
      ]
    },
  ]
}
